...
class _VideoRoomState extends State<GoogleMeet> {
  ...
  joinRoom() async {
    ...
    videoPlugin?.injectMedia(localVideoRenderer.mediaStream);
  ...
  initializeEverything() async {
    ...
    localVideoRenderer.mediaStream = await getMedia();
    videoPlugin?.injectMedia(localVideoRenderer.mediaStream);
  ...
  Future<MediaStream?> getMedia({
    bool? useDisplayMediaDevices = false,
    Map<String, dynamic>? mediaConstraints,
  }) async {
    List<MediaDeviceInfo> videoDevices = await getVideoInputDevicesByUtils();
    List<MediaDeviceInfo> audioDevices = await getAudioInputDevicesByUtils();
